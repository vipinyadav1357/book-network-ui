...
import { findAllReturenedBooks } from '../fn/book/find-all-returened-books';
import { FindAllReturenedBooks$Params } from '../fn/book/find-all-returened-books';
...
import { uploadBookCoverPiture } from '../fn/book/upload-book-cover-piture';
import { UploadBookCoverPiture$Params } from '../fn/book/upload-book-cover-piture';

@Injectable({ providedIn: 'root' })
export class BookService extends BaseService {
  uploadBookCover(bookId: number, selectedBookCover: any) {
  ...
  /** Path part for operation `uploadBookCoverPiture()` */
  static readonly UploadBookCoverPiturePath = '/books/cover/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `uploadBookCoverPiture()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadBookCoverPiture$Response(params: UploadBookCoverPiture$Params, context?: HttpContext): Observable<StrictHttpResponse<{
  }>> {
    return uploadBookCoverPiture(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `uploadBookCoverPiture$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadBookCoverPiture(params: UploadBookCoverPiture$Params, context?: HttpContext): Observable<{
  }> {
    return this.uploadBookCoverPiture$Response(params, context).pipe(
  ...
  /** Path part for operation `findAllReturenedBooks()` */
  static readonly FindAllReturenedBooksPath = '/books/returnBook';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllReturenedBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturenedBooks$Response(params?: FindAllReturenedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllReturenedBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllReturenedBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllReturenedBooks(params?: FindAllReturenedBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllReturenedBooks$Response(params, context).pipe(
  ...
  static readonly FindAllBooksByOwnerPath = '/books/ownerBook';
  ...
  static readonly FindBookByIdPath = '/books/find/{id}';
  ...
  static readonly FindAllBorrowedBooksPath = '/books/borrowedBook';
  ...
  static readonly FindAllBooksPath = '/books/allBook';
