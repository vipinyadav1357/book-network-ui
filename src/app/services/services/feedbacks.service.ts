...
import { findAllFeedBackByBook } from '../fn/feedbacks/find-all-feed-back-by-book';
import { FindAllFeedBackByBook$Params } from '../fn/feedbacks/find-all-feed-back-by-book';
import { PageResponseFeedBackResponse } from '../models/page-response-feed-back-response';
import { saveFeedBack } from '../fn/feedbacks/save-feed-back';
import { SaveFeedBack$Params } from '../fn/feedbacks/save-feed-back';
...
export class FeedbacksService extends BaseService {
  ...
  static readonly SaveFeedBackPath = '/feedbacks/savefeedback';
